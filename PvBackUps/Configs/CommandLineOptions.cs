...
namespace PvBackUps.Configs {
    public class CommandLineOptions {
        ...
        [Value(index: 1, Required = true, HelpText = "Path to watch-out files")]
        ...
        [Option(shortName:'l', longName: "localDisk", Required = false, HelpText = "Path store files locally", Default = "D:\\Temp\\BackUps\\")]
